...
class DatabaseManager
{
     ...
     *
     * Octane hardening: always try purge regardless of getConnections() membership.
     * Under long-running workers a stale PDO may live in the resolver even after
     * the connection config was unset by a previous half-completed teardown.
     */
    public function purgeTenantConnection()
    {
        try {
            ...
            // Purge throws if the connection was never resolved. Safe to ignore.
        }
